            ...
            <div class="row">
                <div class="col-lg-1 col-md-1 col-sm-2 col-xs-4 mb-0" id="div-btn">
                    <a href="{{route('ostad-darkhast-karvarzi')}}">
                        <div class="btn btn-success btn-rounded btn-anim mt-5"><i class="fa fa-download"></i><span
                                class="btn-text">افزودن دانشجو</span>
                        </div>
                    </a>
                </div>
                            ...
                            <table class="table table-striped mb-0" id="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td id="radif">{{$i}}</td>
                                        <td id="namvafamily">
                                            {{$internship->student->name}}{{" "}}{{$internship->student->family}}</td>
                                        ...
                                        <td class="text-nowrap">
                                            <a href="{{route('ostad-darkhast-karvarzi-nahaii',[$internship->student->id])}}"
                                                class="mr-10" data-toggle="tooltip" data-original-title="ثبت">
                                                <i class="fa fa-check" style="color:#2ecd99;"></i>
                                            </a>
                                            <a href="" class="mr-10" data-toggle="tooltip" data-original-title="حذف">
                                                <i class="fa fa-close text-danger"></i>
                                            </a>
                                            <a id="" count="" class="details" data-toggle="tooltip"
