    ...
    <script>
        $(document).ready(function(){
            $(".details").click(function () {
                ...
                $.get('/details/professor', {profId: profId}, function (data) {
            ...
            $(".searchSubmit").click(function () {
                ...
                var count;
                $.get('/search/professor', {searchInput: searchInput}, function (data) {
                    console.log(data);
    ...
    <div class="modal-body">
        <div class="panel-wrapper collapse in">
            <div class="panel-body">
                <div class="table-wrap mt-5">
                    <div class="table-responsive">
                        <form action="{{ route('import.professor.info') }}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
