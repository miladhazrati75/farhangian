    ...
    <div class="wrapper theme-1-active pimary-color-green">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			...
			<div id="mobile_only_nav" class="mobile-only-nav pull-right">
				<ul class="nav navbar-right top-nav pull-right">
					<li class=" mt-5">
						<a id="open_right_sidebar" href="#" ><span class="glyphicon glyphicon-envelope" aria-hidden="true" style="font-size: 20px;"></span></a>
					</li>
							...
							<li>
								<div class="streamline message-nicescroll-bar">
									...
									<div class="sl-item">
										<a href="#">
											<div class="sl-avatar">
												<img class="img-responsive" src="img/user1.png" alt="avatar"/>
											</div>
											<div class="sl-content">
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a href="teacher-list.html" data-toggle="collapse" data-target="#app_dr"><div class="pull-left"><i class="zmdi zmdi-accounts-outline mr-20"></i><span class="right-nav-text">لیست اساتید</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
				...
				<li>
					<a href="place-list.html"><div class="pull-left"><i class="zmdi zmdi-gps mr-20"></i><span class="right-nav-text">لیست حوزه ها</span></div><div class="pull-right"><span class="label label-warning">8</span></div><div class="clearfix"></div></a>
				</li>
														...
														<ul class="nicescroll-bar pt-20">
															<li class="friend">
																<div class="friend-msg-wrap">
																	<img class="user-img img-circle block pull-left"  src="img/user1.png" alt="user"/>
					  ...
					  <div class="panel-heading">
						  ...
						  <nav aria-label="breadcrumb"> 
							<ol class="breadcrumb">
							  ...
							  <li class="breadcrumb-item active">لیست حوزه ها</li>
